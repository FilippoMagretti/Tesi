...
Dopo un accurato rilievo degli ingombri e volumi di lavoro disponibili, l'idea sviluppata consiste in un provino strumentato, che costituisce quindi un \textbf{strumento campione}, capace di leggere il carico di compressione ad esso applicato. L'idea è quella di sfruttare 
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.4\linewidth]{Images/Capitolo_4/Provino.png}
 ...
 \begin{figure}[H]
   \centering
   \includegraphics[width=0.4\linewidth]{Images/Capitolo_4/Rullo.png}     \caption{Rullo}
   \label{fig:Rullo}
 \end{figure}
...
Di seguito è riportato il provinonellasua interezza:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Capitolo_4/Provino_intero.png}
    \caption{Provino}
    \label{fig:Provino}
\end{figure}
...
La particolare forma del provino "a coltello" è stata scelta per compensare l'effetto del momento flettente non voluto, che nasce da un eventuale errore di parallelismo (inevitabile) tra l'asse del cilindro e il piano di contatto del "martello". Questo errore di parallelismo trasformerebbe il contatto di linea tra cilindro e martello in un contatto di punto che genererebbe una componente di momento oltre alla forza di compressione come carico esterno per il provino. La componente di momento esterna indurrebbe la nascita del momento flettente all'interno del corpo centrale del provino, e questo andrebbe a diversificare i valori della tensione normale in direzione assiale (direzione dell'altezza del provino) e di conseguenza anche i valori di deformazione assiale letti dai due ponti estensimetrici presenti sulle due facce del provino. Riducendo la sezione centrale del corpo centrale si riduce l'effetto del momento flettente, uniformando quindi il più possibile le tensioni normali assiali sulle due facce. Per ridurre ulteriormente questo errore, dai due valori ottenuti dai due ponti estensimetrici ne se ricava un terzo ottenuto come media aritmetica dei due. 
