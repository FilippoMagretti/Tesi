...
Come riportato nella tabella \ref{tab:Identificazione dei torsiometri utilizzati} sull'asse 1 (quello posto in alto nell'immagine \ref{fig:Torsiometri}) è posto il torsiometro T-HBM, mentre sull'asse 2 il torsiometro T-Manner. La \textbf{catena di misura} della coppia parte proprio da loro, ed è così costituita:
...
L'idea di base per la realizzazione di un apparecchio meccanico con il quale poter eseguire la taratura dei torsiometri del RENK costiste in un bilanciere che sfrutta dei pesi certificati per generare una coppia mediante un braccio di leva noto.\\
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{Images/Capitolo_2/Ingombro_bilancino.png}
        \caption{Zona T/A vista da davanti}
        \label{fig:Zona T/A vista da davanti}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
    \centering
        \includegraphics[width=1.107\textwidth]{Images/Capitolo_2/Ingombro_bilancino (2).png}
...
Nella figura \ref{fig:Lato T/A } sono mostrati gli alberi dove alloggiano i T/A sui quali saranno montante le componenti del bilancino.
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{Images/Capitolo_2/vista_in_sezione_bilanciere.png}
        \caption{Bilanciere}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{Images/Capitolo_2/vista_in_sezione_bilanciere (2).png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{Images/Capitolo_2/Blocco_cinematico.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{Images/Capitolo_2/Blocco_cinematico_in_sezione.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{Images/Capitolo_2/Dettaglio_bloccco_cinematico.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{Images/Capitolo_2/Bilancino.png}
        \caption{Vista non in sezione}
        \label{fig:Vista non in sezione}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
    \centering
        \includegraphics[width=1\textwidth]{Images/Capitolo_2/Bilancino_in_sezione.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{Images/Capitolo_2/Bilancino_in_sezione(2).png}
        \caption{Sezione bilancino}
        \label{fig:Sezione bilancino}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
    \centering
        \includegraphics[width=0.8\textwidth]{Images/Capitolo_2/Dettaglio_Bilancino_in_sezione.png}
